...
-- Tiempo de generación: 04-09-2023 a las 15:04:15
...
CREATE TABLE IF NOT EXISTS `empleados` (
  ...
  `trabajo` varchar(80) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `edad` int NOT NULL,
  `salario` int NOT NULL,
  `mail` varchar(80) CHARACTER SET armscii8 COLLATE armscii8_general_ci NOT NULL,
  PRIMARY KEY (`id`)
...
(7, 'Eduardo\r\n', 'Sacan', 'Programador', 25, 85000, 'eddi@bignet.com'),
